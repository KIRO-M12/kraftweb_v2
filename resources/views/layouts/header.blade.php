<header class="site-header group/header absolute inset-x-0 top-0 z-50 text-white transition-[background,shadow] [&amp;.lqd-is-sticky]:text-black lqd-is-sticky" x-data="{ navOffsetTop: $refs.navbar.offsetTop - parseInt(getComputedStyle($refs.navbar).marginTop, 10), isSticky: false }" x-init="window.scrollY > navOffsetTop &amp;&amp; (isSticky = true)" @resize.window.debounce.500ms="navOffsetTop = $refs.navbar.offsetTop - parseInt(getComputedStyle($refs.navbar).marginTop, 10)" @scroll.window="window.scrollY > navOffsetTop ? (isSticky = true) : (isSticky = false)" :class="{ 'lqd-is-sticky': isSticky }">
    <div class="site-preheader flex h-12 items-center justify-center bg-[#343C57] bg-cover bg-center px-3 text-center text-[12px] text-white opacity-0 bg-blend-luminosity transition-all duration-500 group-[.page-loaded]/body:opacity-100" style="background-image: url(img/landing-page/preheader-bg.jpg);">
       <p>
    ...
    <nav class="site-header-nav relative flex items-center justify-between border-b border-white/10 px-7 py-4 text-xs opacity-0 transition-all duration-500 group-[.lqd-is-sticky]/header:fixed group-[.lqd-is-sticky]/header:top-0 group-[.lqd-is-sticky]/header:w-full group-[.lqd-is-sticky]/header:border-black group-[.lqd-is-sticky]/header:border-opacity-5 group-[&amp;.lqd-is-sticky]/header:bg-white group-[.page-loaded]/body:opacity-100 group-[&amp;.lqd-is-sticky]/header:shadow-[0_4px_20px_rgba(0,0,0,0.03)] max-sm:px-2" id="frontend-local-navbar" x-ref="navbar">
       ...
       <img class="peer absolute start-0 top-1/2 -translate-y-1/2 translate-x-3 opacity-0 transition-all group-[.lqd-is-sticky]/header:translate-x-0 group-[.lqd-is-sticky]/header:opacity-100" src="http://127.0.0.1:8000/img/logo/magicAI-logo.svg" alt="MagicAI logo">
       <img class="transition-all group-[.lqd-is-sticky]/header:peer-first:translate-x-2 group-[.lqd-is-sticky]/header:peer-first:opacity-0" src="http://127.0.0.1:8000/img/logo/magicAI-logo-dark.svg" alt="MagicAI logo">
       </a>
