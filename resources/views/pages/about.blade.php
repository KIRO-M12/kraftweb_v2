    ...
    <div class="container py-36">
       <div class="row">
          <div class="mx-auto w-full lg:w-10/12 xl:w-8/12">
             <p><img style="display: block; border-radius: 25px; margin-left: auto; margin-right: auto;" src="https://aidefault.liquid-themes.com/wp-content/uploads/2023/08/img-1.jpg" alt="" width="1450" height="761"></p>
             <p style="text-align: center;"><span class="highlight">About Us</span></p>
             <h1 style="text-align: center;">Shaping the future 🏔️</h1>
             <p class="leading" style="max-width: 80%; margin-left: auto; margin-right: auto; text-align: center;">Whether&nbsp;you’re&nbsp;a&nbsp;content&nbsp;creator,&nbsp;business&nbsp;owner,&nbsp;or&nbsp;student, <span style="color: rgb(89, 89, 89);">our&nbsp;text&nbsp;generator&nbsp;is&nbsp;an&nbsp;essential&nbsp;tool&nbsp;for&nbsp;boosting&nbsp;your&nbsp;productivity.</span></p>
             <hr>
             <p>&nbsp;</p>
