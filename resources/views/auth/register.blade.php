                   ...
                   <div class="w-full px-4 text-center text-2xs lg:w-1/2">
                      <div class="container-tight">
                         ...
                         <div class="flex flex-wrap justify-between gap-4">
                            ...
                            <a class="lqd-btn group inline-flex items-center gap-1.5 text-xs font-medium transition-all hover:-translate-y-0.5 hover:shadow-xl hover:shadow-black/5 [&amp;[disabled]]:bg-foreground [&amp;[disabled]]:opacity-30 [&amp;[disabled]]:pointer-events-none lqd-btn-outline outline outline-input-border -outline-offset-1 focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-secondary lqd-btn-md py-2 px-4 lqd-btn-hover-none grow basis-full justify-start rounded-xl sm:basis-[45%]" href="https://www.facebook.com/v3.3/dialog/oauth?redirect_uri=https%3A%2F%2Fmagicai.liquid-themes.com%2Ffacebook%2Fcallback&amp;scope=email&amp;response_type=code&amp;state=UIhzNKUagpVbsLAF7FbQ7a16yfJaPuay9jFS7L5d">
                         ...
                         <form class="flex flex-col gap-6" novalidate="novalidate" onsubmit="return RegisterForm();">
                            <input id="plan" type="hidden" name="plan" value="">
                            <input id="affiliate_code" type="hidden" value="">
                            <div class="lqd-input-container relative">
                               <label class="lqd-input-label flex cursor-pointer items-center gap-2 text-2xs font-medium leading-none text-label mb-3" for="name_register">
                               <span class="lqd-input-label-txt">
                               Name
                               </span>
                               </label>
                               <input id="name_register" required="required" class="lqd-input block peer w-full px-4 py-2 border border-input-border bg-input-background text-input-foreground text-base ring-offset-0 transition-colors focus:border-secondary focus:outline-0 focus:ring focus:ring-secondary dark:focus:ring-foreground/10 sm:text-2xs lqd-input-lg h-11 rounded-xl" name="" value="" type="text" placeholder="Your Name">
                            </div>
                            <div class="lqd-input-container relative">
                               <label class="lqd-input-label flex cursor-pointer items-center gap-2 text-2xs font-medium leading-none text-label mb-3" for="surname_register">
                               <span class="lqd-input-label-txt">
                               Last Name
                               </span>
                               </label>
                               <input id="surname_register" required="required" class="lqd-input block peer w-full px-4 py-2 border border-input-border bg-input-background text-input-foreground text-base ring-offset-0 transition-colors focus:border-secondary focus:outline-0 focus:ring focus:ring-secondary dark:focus:ring-foreground/10 sm:text-2xs lqd-input-lg h-11 rounded-xl" name="" value="" type="text" placeholder="Your Last Name">
                            </div>
                            <div class="lqd-input-container relative">
                               <label class="lqd-input-label flex cursor-pointer items-center gap-2 text-2xs font-medium leading-none text-label mb-3" for="email_register">
                               <span class="lqd-input-label-txt">
                               Email Address
                               </span>
                               </label>
                               <input id="email_register" required="required" class="lqd-input block peer w-full px-4 py-2 border border-input-border bg-input-background text-input-foreground text-base ring-offset-0 transition-colors focus:border-secondary focus:outline-0 focus:ring focus:ring-secondary dark:focus:ring-foreground/10 sm:text-2xs lqd-input-lg h-11 rounded-xl" name="" value="" type="email" placeholder="your@email.com">
                            </div>
                            <div class="lqd-input-container relative" x-data="{
                               ...
                               <label class="lqd-input-label flex cursor-pointer items-center gap-2 text-2xs font-medium leading-none text-label mb-3" for="password_register">
                               <span class="lqd-input-label-txt">
                               Password
                               </span>
                               </label>
                               <div class="relative">
                                  <input id="password_register" required="required" class="lqd-input block peer w-full px-4 py-2 border border-input-border bg-input-background text-input-foreground text-base ring-offset-0 transition-colors focus:border-secondary focus:outline-0 focus:ring focus:ring-secondary dark:focus:ring-foreground/10 sm:text-2xs lqd-input-lg h-11 rounded-xl" name="" value="" :type="type" type="password" placeholder="Your password">
                            ...
                            <div class="lqd-input-container relative" x-data="{
                               ...
                               <label class="lqd-input-label flex cursor-pointer items-center gap-2 text-2xs font-medium leading-none text-label mb-3" for="password_confirmation_register">
                               <span class="lqd-input-label-txt">
                               Confirm Your Password
                               </span>
                               </label>
                               <div class="relative">
                                  <input id="password_confirmation_register" required="required" class="lqd-input block peer w-full px-4 py-2 border border-input-border bg-input-background text-input-foreground text-base ring-offset-0 transition-colors focus:border-secondary focus:outline-0 focus:ring focus:ring-secondary dark:focus:ring-foreground/10 sm:text-2xs lqd-input-lg h-11 rounded-xl" name="" value="" :type="type" type="password" placeholder="Password confirmation">
                                  <button class="lqd-show-password size-7 absolute end-3 top-1/2 z-10 inline-flex -translate-y-1/2 cursor-pointer items-center justify-center rounded bg-none transition-colors hover:bg-foreground/10" type="button" @click="toggleType()">
                                     <svg stroke-width="1.5" :class="inputValueVisible ? 'hidden' : ''" class="w-5" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"></path>
                                        <path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6"></path>
                            ...
                            <button class="lqd-btn group inline-flex items-center justify-center gap-1.5 font-medium rounded-full transition-all hover:-translate-y-0.5 hover:shadow-xl [&amp;[disabled]]:bg-foreground [&amp;[disabled]]:opacity-30 [&amp;[disabled]]:pointer-events-none lqd-btn-primary bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-primary/10 focus-visible:bg-primary/90 focus-visible:shadow-primary/10 lqd-btn-md py-2 px-4 lqd-btn-hover-none text-sm" id="RegisterFormButton" type="submit">
                            Sign up
                            </button>
                         </form>
                      </div>
                      <div class="text-muted mt-10">
                         Have an account?
                         <a class="font-medium text-indigo-600 underline" href="login.html">
                         Sign in
                         </a>
                      </div>
                   </div>
